...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn2B = (Button)findViewById(R.id.btn_3to444);
        btn2B.setOnClickListener(btn2B_click);

        Button btn3B = (Button)findViewById(R.id.btn_BtoC1122);
        btn3B.setOnClickListener(btn3B_click);

        Button btn4B = (Button)findViewById(R.id.back11222);
        btn4B.setOnClickListener(btn4B_click);

        Button btn5B = (Button)findViewById(R.id.btn_CtoB9999);
        btn5B.setOnClickListener(btn5B_click);

        Button btn6B = (Button)findViewById(R.id.btn_CtoA22222);
